    ...
    <div className="app-root">
      <div className="interview-layout">
        ...
        <div className="interview-container">
          ...
          {/* Random Prompt Generator Launch Button */}
          <button
            className="random-prompt-launch-button"
            onClick={() => setIsRandomPromptModalOpen(true)}
            title="Open Random Prompt Generator"
          >
            <span className="random-prompt-launch-icon">🎲</span>
            <span className="random-prompt-launch-text">Open Random Prompt Generator</span>
          </button>

          {/* App Tutorial Launch Button */}
          <button
            className="app-tutorial-launch-button"
            onClick={() => setIsAppTutorialOpen(true)}
            title="Open Tutorial"
          >
            <span className="app-tutorial-launch-icon">?</span>
            <span className="app-tutorial-launch-text">Tutorial</span>
          </button>
